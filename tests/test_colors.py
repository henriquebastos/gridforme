...
def test_hexcolor():
    ...
    assert (255, 255, 255, 0)   == hexcolor('ffffff') == hexcolor('ffffffa')
    assert (255, 255, 255, 0)   == hexcolor('ffffff00')
    assert (255, 255, 255, 255) == hexcolor('ffffffffff')

def test_rgbcolor():
    assert (255, 255, 255, 255) == rgbcolor('255,255,255,255')
    assert (255, 255, 255, 0)   == rgbcolor('255,255,255')
...
def test_color():
    ...
    assert (255, 255, 255, 0) == color('ffffff') == color('255,255,255') == color('', (255, 255, 255, 0))
    assert (0, 0, 0, 0) == color('')
